...
import com.madone.virtualexpo.android.totpgenerator.ui.MainActivity;
import com.madone.virtualexpo.android.totpgenerator.ui.MessageDialogFragment;
import com.madone.virtualexpo.android.totpgenerator.ui.PinActivity;
    ...
    public void handleResult(Result rawResult) {
        ...
        try {
            ...
            PreferenceManager.getDefaultSharedPreferences(getActivity())
                    .edit()
                    .putString("E_TOKEN", AES.encrypt(secretKey, iv, rawResult.getText()))
                    .apply();
            ...
            // Log.i("HUI2", "AES.ecrypt(" + PinActivity.mPinCode + ", " + iv + ", " + rawResult.getText() + ") = " + cipher);
            Log.i("DECODING", AES.decrypt(secretKey, iv, AES.encrypt(secretKey, iv, rawResult.getText())));
